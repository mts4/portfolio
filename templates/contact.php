...
<!--                 <div class="col-md-6 col-lg-4">
                    <div class="featured-box text-center my-3 my-md-0 wow bounceIn">
                        ...
                        <h3 class="text-uppercase text-white">Visit Us</h3>
                        <p class="text-white-50 mb-0">145 Murphy Canyon Rd.<br>
                ...
                <div class="col-md-6 col-lg-6">
                    <div class="featured-box text-center my-3 my-md-0 wow bounceIn">
                        ...
                        <h3 class="text-uppercase text-white">Email</h3>
                        <p class="text-white-50 mb-0"><a class="text-white-50" href="mailto:contacto@amusdev.cl">contacto@amusdev.cl</a></p>
                    </div>
                </div>
            </div>
        </div>
